...
z = {ecuacion_z}""")
    ...
    for i in range(1,90+1):
        ...
        xi = obtener_valores_variables(ecuacion_x, ((x, xi),(y, yi), (z, zi)))
        yi = obtener_valores_variables(ecuacion_y, ((x, xi),(y, yi), (z, zi)))
        zi = obtener_valores_variables(ecuacion_z, ((x, xi),(y, yi), (z, zi)))
